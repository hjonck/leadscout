...
class TestCIPCCompany:
    ...
    def test_registration_number_validation(self):
        ...
        with pytest.raises(
            ValueError, match="Registration number is required"
        ):
            CIPCCompany(
                registration_number="",
                company_name="Test Company",
...
class TestCIPCProcessingStats:
    ...
    def test_download_success_rate(self):
        ...
        stats = CIPCProcessingStats(
            successful_downloads=24, failed_downloads=2
        )
    ...
    def test_names_per_company_ratio(self):
        ...
        stats = CIPCProcessingStats(
            total_companies_processed=1000, total_names_extracted=500
        )
