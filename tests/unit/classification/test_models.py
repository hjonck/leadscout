...
from leadscout.classification.models import (
    Classification, ClassificationMethod, ConfidenceLevel, EthnicityType,
    RuleClassificationDetails, PhoneticClassificationDetails, PhoneticMatch,
    AlternativeClassification, ClassificationRequest, BatchClassificationRequest,
    ValidationResult, ClassificationStats
)
...
class TestClassification:
    ...
    def test_confidence_level_auto_assignment(self):
        ...
        c1 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN, 
            confidence=0.97, method=ClassificationMethod.RULE_BASED
        )
        ...
        c2 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN,
            confidence=0.88, method=ClassificationMethod.RULE_BASED
        )
        ...
        c3 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN,
            confidence=0.75, method=ClassificationMethod.PHONETIC
        )
        ...
        c4 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN,
            confidence=0.60, method=ClassificationMethod.PHONETIC
        )
        ...
        c5 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN,
            confidence=0.40, method=ClassificationMethod.LLM
        )
    ...
    def test_confidence_validation(self):
        ...
        c1 = Classification(
            name="Test", ethnicity=EthnicityType.AFRICAN,
            confidence=0.75, method=ClassificationMethod.RULE_BASED
        )
        ...
        with pytest.raises(ValueError):
            Classification(
                name="Test", ethnicity=EthnicityType.AFRICAN,
                confidence=-0.1, method=ClassificationMethod.RULE_BASED
            )
        ...
        with pytest.raises(ValueError):
            Classification(
                name="Test", ethnicity=EthnicityType.AFRICAN,
                confidence=1.1, method=ClassificationMethod.RULE_BASED
            )
...
class TestClassificationStats:
    ...
    def test_stats_multiple_updates(self):
        ...
        rule_classification = Classification(
            name="Test1", ethnicity=EthnicityType.AFRICAN,
            confidence=0.90, method=ClassificationMethod.RULE_BASED
        )
        stats.update_with_classification(rule_classification)
        
        # Add LLM classification
        llm_classification = Classification(
            name="Test2", ethnicity=EthnicityType.INDIAN,
            confidence=0.75, method=ClassificationMethod.LLM
        )
