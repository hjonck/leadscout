...
def get_test_dataset() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {
            "name": "Thabo Mthembu",
            "expected_ethnicity": EthnicityType.AFRICAN,
            "category": "nguni",
        },
        {
            "name": "Bongani Nkomo",
        ...
        {
            "name": "Priya Pillay",
            "expected_ethnicity": EthnicityType.INDIAN,
            "category": "tamil",
        },
        {
            "name": "Rajesh Naidoo",
        ...
        # Cape Malay names
        {
            "name": "Abdullah Cassiem",
            "expected_ethnicity": EthnicityType.CAPE_MALAY,
            "category": "cape_malay",
        },
        {
        ...
        {
            "name": "John September",
            "expected_ethnicity": EthnicityType.COLOURED,
            "category": "month_surname",
        },
        {
            "name": "Mary April",
            "expected_ethnicity": EthnicityType.COLOURED,
        ...
        # White names - Afrikaans
        {
            ...
            "expected_ethnicity": EthnicityType.WHITE,
            "category": "afrikaans",
        },
        {
            "name": "Johannes Botha",
...
def get_accuracy_metrics_by_ethnicity() -> Dict[EthnicityType, Dict[str, int]]:
    ...
    for ethnicity in EthnicityType:
        ...
        exact_matches = len(
            [d for d in test_data if d["expected_ethnicity"] == ethnicity]
        )
        phonetic_matches = len(
            [d for d in phonetic_data if d["expected_ethnicity"] == ethnicity]
        )
