...
class NameDictionaries:
    ...
    def _load_all_dictionaries(self) -> None:
        ...
        logger.info(f"Loaded {total_names} names across {len(self.dictionaries)} ethnicities")
    ...
    def _load_african_names(self) -> Dict[str, NameEntry]:
        ...
        nguni_surnames = [
            # Zulu surnames
            "Mthembu", "Nkomo", "Dlamini", "Ndlovu", "Zungu", "Khumalo", "Mnguni",
            "Buthelezi", "Cele", "Makhanya", "Zulu", "Gumede", "Shabalala", "Mbeki",
            "Mchunu", "Ngcobo", "Bhengu", "Majola", "Mahlangu", "Sibiya", "Maphumulo",
            "Madonsela", "Magwaza", "Msibi", "Madlala", "Mazibuko", "Mbatha", "Memela",
            
            # Xhosa surnames  
            "Mandela", "Mbeki", "Sisulu", "Mda", "Mgqweto", "Mqhayi", "Ntshona",
            "Goniwe", "Biko", "Sobukwe", "Makoma", "Mthathi", "Dlomo", "Gqirana",
            "Kente", "Makana", "Maqoma", "Mqhayi", "Ntsebeza", "Qoma", "Tyhali",
            
            # Other Nguni
            "Maseko", "Mavimbela", "Simelane", "Tsabedze", "Fakude", "Nxumalo"
        ]
        
        nguni_forenames = [
            # Zulu forenames
            "Thabo", "Sipho", "Bongani", "Nkosana", "Mandla", "Sandile", "Sizani",
            "Nomsa", "Zodwa", "Thandi", "Zinhle", "Nokuthula", "Ntombi", "Busisiwe",
            "Kagiso", "Lerato", "Tumelo", "Tebogo", "Refilwe", "Kgothatso",
            
            # Xhosa forenames
            "Thulani", "Mzwandile", "Lunga", "Luyanda", "Andile", "Siyabonga",
            "Nomonde", "Noluthando", "Zinzi", "Pumla", "Yolanda", "Bulelani"
        ]
        
        # Sotho names (Northern Sotho/Pedi, Southern Sotho, Tswana)
        sotho_surnames = [
            # Pedi/Northern Sotho
            "Malema", "Ramaphosa", "Sekwale", "Mphahlele", "Matlala", "Mamabolo",
            "Ledwaba", "Mokgohloa", "Phala", "Sebola", "Mahlangu", "Kganyago",
            
            # Southern Sotho
            "Motsoaledi", "Mokoena", "Mthembu", "Molefe", "Tsotetsi", "Mosia",
            "Ramotswe", "Letsie", "Mohapi", "Rampai", "Mofokeng", "Moloi",
            
            # Tswana
            "Masire", "Seretse", "Khama", "Mogae", "Kgositsile", "Motsepe",
            "Kgalagadi", "Mmusi", "Pilane", "Tlhaping", "Barolong", "Kwena"
        ]
        
        sotho_forenames = [
            "Kgalema", "Cyril", "Thabang", "Tshepo", "Katlego", "Lesego",
            "Boitumelo", "Palesa", "Dimakatso", "Keabetswe", "Reratile",
            "Mmabatho", "Nthabiseng", "Kgomotso", "Tebogo", "Goitseone"
        ]
        
        # Venda names
        venda_names = [
            "Ramaphosa", "Mphephu", "Mudau", "Ramavhoya", "Tshivhase", "Netshitenzhe",
            "Ramarumo", "Mufamadi", "Nemukula", "Tshikovhi", "Mudavanhu", "Raliphaswa",
            "Vhembe", "Matomela", "Rudzani", "Fulufhelo", "Khangale", "Mavhandu"
        ]
    ...
    def _load_indian_names(self) -> Dict[str, NameEntry]:
        ...
        tamil_surnames = [
            "Pillay", "Naidoo", "Reddy", "Naicker", "Raman", "Krishnan", "Murugan",
            "Govind", "Maharaj", "Singh", "Devi", "Kumar", "Sharma", "Patel",
            "Moodley", "Nair", "Iyer", "Rao", "Chetty", "Sundaram", "Ramesh",
            "Anil", "Sunil", "Pravin", "Ashwin", "Deepak", "Rajesh", "Mahesh"
        ]
        
        # Telugu names
        telugu_surnames = [
            "Reddy", "Rao", "Naidu", "Chandra", "Krishna", "Venkata", "Srinivas",
            "Ramesh", "Suresh", "Rajesh", "Ganesh", "Mahesh", "Dinesh", "Naresh"
        ]
        
        # Hindi/North Indian names
        hindi_surnames = [
            "Sharma", "Gupta", "Singh", "Kumar", "Agarwal", "Jain", "Bansal",
            "Mittal", "Goyal", "Arora", "Kapoor", "Khanna", "Malhotra", "Chopra"
        ]
        
        # Gujarati names
        gujarati_surnames = [
            "Patel", "Shah", "Modi", "Desai", "Mehta", "Parmar", "Solanki",
            "Trivedi", "Joshi", "Pandya", "Bhatt", "Dave", "Amin", "Thakkar"
        ]
    ...
    def _load_cape_malay_names(self) -> Dict[str, NameEntry]:
        ...
        cape_malay_surnames = [
            "Adams", "Arendse", "Cassiem", "Daniels", "Esau", "Galant", "Hendricks",
            "Isaacs", "Jacobs", "Khan", "Lawrence", "Manuel", "Moses", "Nordien",
            "October", "Petersen", "Qureshi", "Reynolds", "Samuels", "Titus",
            "Uys", "Valentine", "Williams", "Xafrica", "Yusuf", "Zimri",
            "Abdullah", "Abrahams", "Alexander", "Benjamin", "Carolus", "Davids",
            "Fortune", "Gabriel", "Isaacs", "Kamaldien", "Latief"
        ]
        
        cape_malay_forenames = [
            "Abdullah", "Ahmed", "Ali", "Amina", "Ayesha", "Bibi", "Fadiel",
            "Fatima", "Hassan", "Ibrahim", "Jamal", "Khadija", "Mohamed",
            "Nadia", "Omar", "Rasheed", "Safiya", "Tariq", "Yasmin", "Zainab"
        ]
    ...
    def _load_coloured_names(self) -> Dict[str, NameEntry]:
        ...
        coloured_surnames = [
            "Booysen", "Brown", "Carolus", "Davids", "Fortune", "Galant",
            "Jantjies", "Koopman", "Louw", "Moses", "Peters", "Samuels",
            "Solomons", "Titus", "Valentine", "Windvogel", "Afrika", "Abrahams"
        ]
    ...
    def _load_white_names(self) -> Dict[str, NameEntry]:
        ...
        # Afrikaans surnames
        afrikaans_surnames = [
            "Van der Merwe", "Botha", "Pretorius", "Van Zyl", "Steyn", "Du Plessis",
            "Fourie", "Le Roux", "Van der Walt", "Joubert", "Venter", "De Wet",
            "Kruger", "Nel", "Smit", "Coetzee", "Potgieter", "Wessels", "Burger",
            "Du Toit", "Conradie", "Erasmus", "Human", "Lotter", "Marais"
        ]
        ...
        # Afrikaans forenames
        afrikaans_forenames = [
            "Johannes", "Pieter", "Jacobus", "Andries", "Hendrik", "Christiaan",
            "Willem", "Gerhardus", "Stephanus", "Francois", "Martinus", "Cornelis",
            "Maria", "Anna", "Elizabeth", "Susanna", "Catharina", "Johanna",
            "Magdalena", "Petronella", "Aletta", "Hester", "Sannie", "Lettie"
        ]
    ...
    def lookup_name(self, name: str, ethnicity: Optional[EthnicityType] = None) -> Optional[NameEntry]:
